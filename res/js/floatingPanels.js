...
TheShodo.Shodo.Write.PanelSelectBrush.prototype.onBrushSelected = function(brushName) {
...
TheShodo.Shodo.Write.PanelSelectInk.prototype.onBeforePanelShow = function(selectedOpacity, selectedColor) {
    ...
    .find('li.opacity-' + ((selectedOpacity || this.selectedOpacity) * 100))
        .addClass('selected')
        .end()
        .find('li.color-' + (function(v) {
            var s = v.toString(16);
            return new Array(7 - s.length).join('0') + s; })(selectedColor || this.selectedColor))
        .addClass('selected')
        .end();
}
TheShodo.Shodo.Write.PanelSelectInk.prototype.onInkSelected = function(opacity, texture) {
    throw "NotImplemented"; }
...
TheShodo.Shodo.Write.PanelSelectPaper.prototype.onPaperSelected = function(paperName) {
    throw "NotImplemented"; }
